...
const BlogCard: React.FC<BlogCardProps> = ({ image, title, description }) => {
  return (
    <>
      <div className="dark:text-white group mx-3">
        ...
        <div className="space-y-2 p-4 h-[235px] ml-6 bg-white dark:bg-slate-950 -translate-y-16">
          <h1 className="text-1xlsm:text-2xl font-semibold">{title}</h1>
